...
public class GmailAdapter extends ArrayAdapter<String> implements Filterable {
    ...
    public GmailAdapter(FragmentActivity context, int resource, List<String> objects) {
        ...
        this.friendList2=friendList;
         myFilter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if(constraint != null && friendList2!=null) {
    ...
    public long getItemId(int position) {
       // return position;
            ...
            return friendList.indexOf((String) friendList2.get(position));
